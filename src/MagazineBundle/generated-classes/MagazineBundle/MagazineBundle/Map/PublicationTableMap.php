...
use MagazineBundle\MagazineBundle\Publication;
use MagazineBundle\MagazineBundle\PublicationQuery;
...
class PublicationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MagazineBundle.MagazineBundle.Map.PublicationTableMap';
     ...
     */
    const OM_CLASS = '\\MagazineBundle\\MagazineBundle\\Publication';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MagazineBundle.MagazineBundle.Publication';
     ...
     */
    const COL_NAME = 'publication.name';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(PublicationTableMap::COL_ID, PublicationTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(PublicationTableMap::COL_ID => 0, PublicationTableMap::COL_NAME => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MagazineBundle\\MagazineBundle\\Publication');
    ...
    {
        $this->addRelation('Issue', '\\MagazineBundle\\MagazineBundle\\Issue', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publication_id',
    1 => ':id',
  ),
), 'CASCADE', null, 'Issues', false);
    } // buildRelations()
    /**
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PublicationTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MagazineBundle\MagazineBundle\Publication) { // it's a model object
