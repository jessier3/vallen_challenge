...
namespace MagazineBundle\MagazineBundle\Map;

use MagazineBundle\MagazineBundle\Issue;
use MagazineBundle\MagazineBundle\IssueQuery;
...
class IssueTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MagazineBundle.MagazineBundle.Map.IssueTableMap';
     ...
     */
    const OM_CLASS = '\\MagazineBundle\\MagazineBundle\\Issue';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MagazineBundle.MagazineBundle.Issue';
     ...
     */
    const COL_NUMBER = 'issue.number';

    /**
     * the column name for the date_publication field
     */
    const COL_DATE_PUBLICATION = 'issue.date_publication';

    /**
     * the column name for the cover field
     */
    const COL_COVER = 'issue.cover';

    /**
     * the column name for the publication_id field
     */
    const COL_PUBLICATION_ID = 'issue.publication_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Number', 'DatePublication', 'Cover', 'PublicationId', ),
        self::TYPE_CAMELNAME     => array('id', 'number', 'datePublication', 'cover', 'publicationId', ),
        self::TYPE_COLNAME       => array(IssueTableMap::COL_ID, IssueTableMap::COL_NUMBER, IssueTableMap::COL_DATE_PUBLICATION, IssueTableMap::COL_COVER, IssueTableMap::COL_PUBLICATION_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'number', 'date_publication', 'cover', 'publication_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Number' => 1, 'DatePublication' => 2, 'Cover' => 3, 'PublicationId' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'number' => 1, 'datePublication' => 2, 'cover' => 3, 'publicationId' => 4, ),
        self::TYPE_COLNAME       => array(IssueTableMap::COL_ID => 0, IssueTableMap::COL_NUMBER => 1, IssueTableMap::COL_DATE_PUBLICATION => 2, IssueTableMap::COL_COVER => 3, IssueTableMap::COL_PUBLICATION_ID => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'number' => 1, 'date_publication' => 2, 'cover' => 3, 'publication_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MagazineBundle\\MagazineBundle\\Issue');
        $this->setPackage('MagazineBundle.MagazineBundle');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('number', 'Number', 'INTEGER', true, null, null);
        $this->addColumn('date_publication', 'DatePublication', 'DATE', false, null, null);
        $this->addColumn('cover', 'Cover', 'VARCHAR', false, 255, '');
    ...
    {
        $this->addRelation('Publication', '\\MagazineBundle\\MagazineBundle\\Publication', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publication_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(IssueTableMap::COL_NUMBER);
            $criteria->addSelectColumn(IssueTableMap::COL_DATE_PUBLICATION);
            $criteria->addSelectColumn(IssueTableMap::COL_COVER);
            $criteria->addSelectColumn(IssueTableMap::COL_PUBLICATION_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MagazineBundle\MagazineBundle\Issue) { // it's a model object
