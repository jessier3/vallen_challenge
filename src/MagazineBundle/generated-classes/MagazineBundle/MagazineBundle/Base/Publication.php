 ...
 */
class Publication implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\MagazineBundle\\MagazineBundle\\Map\\PublicationTableMap';
    ...
    /**
     * Initializes internal state of MagazineBundle\MagazineBundle\Base\Publication object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\MagazineBundle\MagazineBundle\Publication The current object (for fluent API support)
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[PublicationTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PublicationTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = PublicationTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MagazineBundle\\MagazineBundle\\Publication'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->issuesScheduledForDeletion !== null) {
                if (!$this->issuesScheduledForDeletion->isEmpty()) {
                    \MagazineBundle\MagazineBundle\IssueQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PublicationTableMap::COL_NAME)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MagazineBundle\MagazineBundle\Publication
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MagazineBundle\MagazineBundle\Publication The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PublicationTableMap::COL_NAME)) {
            $criteria->add(PublicationTableMap::COL_NAME, $this->name);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MagazineBundle\MagazineBundle\Publication (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MagazineBundle\MagazineBundle\Publication Clone of current object.
     * @throws PropelException
     */
    ...
    public function initIssues($overrideExisting = true)
    {
        ...
        $this->collIssues->setModel('\MagazineBundle\MagazineBundle\Issue');
    }
    ...
    public function setIssues(Collection $issues, ConnectionInterface $con = null)
    {
        ...
        foreach ($issuesToDelete as $issueRemoved) {
            $issueRemoved->setPublication(null);
        }
    ...
    {
        return (string) $this->exportTo(PublicationTableMap::DEFAULT_STRING_FORMAT);
    }
