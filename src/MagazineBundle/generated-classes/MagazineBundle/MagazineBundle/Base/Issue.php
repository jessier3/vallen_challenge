 ...
 *
 *
 * @package    propel.generator.MagazineBundle.MagazineBundle.Base
 */
class Issue implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\MagazineBundle\\MagazineBundle\\Map\\IssueTableMap';
    ...
    /**
     * Initializes internal state of MagazineBundle\MagazineBundle\Base\Issue object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [optionally formatted] temporal [date_publication] column value.
     *
     *
    ...
    public function getDatePublication($format = NULL)
    {
        if ($format === null) {
            ...
            return $this->date_publication instanceof \DateTimeInterface ? $this->date_publication->format($format) : null;
        }
    }
     ...
     * @return $this|\MagazineBundle\MagazineBundle\Issue The current object (for fluent API support)
     */
    ...
    public function setNumber($v)
    {
        ...
        if ($this->number !== $v) {
            $this->number = $v;
            $this->modifiedColumns[IssueTableMap::COL_NUMBER] = true;
        }
    ...
    /**
     * Sets the value of [date_publication] column to a normalized version of the date/time value specified.
     *
    ...
    public function setDatePublication($v)
    {
        ...
        if ($this->date_publication !== null || $dt !== null) {
            if ($this->date_publication === null || $dt === null || $dt->format("Y-m-d") !== $this->date_publication->format("Y-m-d")) {
                $this->date_publication = $dt === null ? null : clone $dt;
                $this->modifiedColumns[IssueTableMap::COL_DATE_PUBLICATION] = true;
            }
    ...
    public function setCover($v)
    {
        ...
        if ($this->cover !== $v) {
            $this->cover = $v;
            $this->modifiedColumns[IssueTableMap::COL_COVER] = true;
        }
    ...
    public function setPublicationId($v)
    {
        ...
        if ($this->publication_id !== $v) {
            ...
            $this->modifiedColumns[IssueTableMap::COL_PUBLICATION_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : IssueTableMap::translateFieldName('Number', TableMap::TYPE_PHPNAME, $indexType)];
            $this->number = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : IssueTableMap::translateFieldName('DatePublication', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date_publication = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : IssueTableMap::translateFieldName('Cover', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cover = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : IssueTableMap::translateFieldName('PublicationId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = IssueTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MagazineBundle\\MagazineBundle\\Issue'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(IssueTableMap::COL_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'number';
        }
        if ($this->isColumnModified(IssueTableMap::COL_DATE_PUBLICATION)) {
            $modifiedColumns[':p' . $index++]  = 'date_publication';
        }
        if ($this->isColumnModified(IssueTableMap::COL_COVER)) {
            $modifiedColumns[':p' . $index++]  = 'cover';
        }
        if ($this->isColumnModified(IssueTableMap::COL_PUBLICATION_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'date_publication':
                        $stmt->bindValue($identifier, $this->date_publication ? $this->date_publication->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'cover':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getDatePublication(),
            $keys[3] => $this->getCover(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MagazineBundle\MagazineBundle\Issue
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setDatePublication($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setCover($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setPublicationId($arr[$keys[4]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MagazineBundle\MagazineBundle\Issue The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(IssueTableMap::COL_NUMBER)) {
            $criteria->add(IssueTableMap::COL_NUMBER, $this->number);
        }
        if ($this->isColumnModified(IssueTableMap::COL_DATE_PUBLICATION)) {
            $criteria->add(IssueTableMap::COL_DATE_PUBLICATION, $this->date_publication);
        }
        if ($this->isColumnModified(IssueTableMap::COL_COVER)) {
            $criteria->add(IssueTableMap::COL_COVER, $this->cover);
        }
        if ($this->isColumnModified(IssueTableMap::COL_PUBLICATION_ID)) {
            $criteria->add(IssueTableMap::COL_PUBLICATION_ID, $this->publication_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MagazineBundle\MagazineBundle\Issue (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MagazineBundle\MagazineBundle\Issue Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if (null !== $this->aPublication) {
            $this->aPublication->removeIssue($this);
        }
        $this->id = null;
        $this->number = null;
